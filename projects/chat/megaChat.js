...
import NumberEntries from './ui/numberEntries';
...
export default class MegaChat {
  constructor() {
    ...
    this.ui = {
      ...
      numberEntries: new NumberEntries(document.querySelector('[data-role=number-entries]')),
